...
const timeline = [
  ...
  },
  {
    ...
    period: "2026",
    location: "Remote",
    description: "Contributing to live open-source software repositories at the Vicharanashala Lab for Education Design (VLED Lab), addressing real India-centric educational challenges. Making direct code contributions, collaborating with research mentors, and solving technical bottlenecks.",
              ...
              return (
                <motion.div key={i}
                  ...
                  <motion.div whileHover={{ x: 4 }}
                    className="flex-1 glass-panel rounded-2xl p-6 transition-all duration-300 group border-white/[0.07] hover:border-white/18">
