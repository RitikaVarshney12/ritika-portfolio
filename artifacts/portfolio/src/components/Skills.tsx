...
const skillCategories = [
  ...
  },
  {
    ...
    border: "hover:border-orange-400/35",
    glow: "group-hover:shadow-orange-400/15",
...
const techLogos: Record<string, string> = {
  ...
  "Machine Learning": "🤖", "Data Science": "📊", "Computer Vision": "👁️",
  Git: "🌿", GitHub: "🐙", "VS Code": "💻",
      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        >
          ...
          <p className="text-white/40 max-w-md mx-auto text-sm">
            A growing toolkit built through projects, internships, and a genuine love for learning.
          </p>
        </motion.div>
