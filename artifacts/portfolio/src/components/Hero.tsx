...
export function Hero() {
  return (
    <section id="hero" className="relative min-h-[100dvh] flex items-center pt-20 overflow-hidden bg-[#08080d]">
      ...
      <div className="container relative z-10 mx-auto px-6 md:px-12 flex flex-col lg:flex-row items-center gap-16 py-16">
        ...
        <div className="flex-1 max-w-2xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}
            ...
            <span className="text-xs font-montserrat font-semibold tracking-widest uppercase text-violet-300">Available for Opportunities</span>
          </motion.div>
          ...
          <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, duration: 0.7 }}
            ...
            <span className="relative">
              ...
              <motion.span className="absolute -bottom-1 left-0 h-0.5 bg-gradient-to-r from-violet-500 to-cyan-400 rounded-full"
        ...
        <motion.div initial={{ opacity: 0, scale: 0.75 }} animate={{ opacity: 1, scale: 1 }}
          ...
          <div className="relative">
            ...
            <div className="absolute -top-3 left-1/2 w-4 h-4 -translate-x-1/2 rounded-full bg-cyan-400 shadow-lg shadow-cyan-400/50 animate-[spin_6s_linear_infinite]"
              style={{ transformOrigin: "50% calc(50% + 160px)" }} />
            <div className="relative w-72 h-72 xl:w-80 xl:h-80 rounded-full overflow-hidden border-4 border-white/10 shadow-2xl shadow-violet-900/40">
              <img src="https://i.postimg.cc/MGCgGnsm/mine.jpg" alt="Ritika Varshney"
