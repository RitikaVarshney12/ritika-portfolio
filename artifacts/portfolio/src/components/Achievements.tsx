...
import { Award, Star, Trophy, Zap, BookOpen, Lightbulb, Globe, Layout, Server, Coffee, Brain, BarChart2, FlaskConical, GitMerge, Users2 } from "lucide-react";
...
const contributionIcons = [Globe, Layout, Server, Coffee, Brain, BarChart2, FlaskConical, GitMerge, Users2];
...
export function Achievements() {
  return (
    <section className="relative py-28 overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_70%_50%_at_60%_40%,rgba(6,182,212,0.08),transparent)]" />
      ...
      <div className="container mx-auto px-6 md:px-12">
          ...
          {PORTFOLIO_DATA.achievements.map((achievement, i) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-white/70 font-medium text-sm leading-relaxed pt-1 group-hover:text-white/90 transition-colors">{achievement}</p>
              </motion.div>
            );
          })}
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 gap-4 max-w-4xl mx-auto mb-20">
          {PORTFOLIO_DATA.areasOfContribution.map((area, i) => {
            ...
            return (
              ...
              >
                <div className={`w-11 h-11 rounded-xl bg-gradient-to-br ${contributionColors[i % contributionColors.length]} flex items-center justify-center shadow-md transition-transform group-hover:scale-110`}>
