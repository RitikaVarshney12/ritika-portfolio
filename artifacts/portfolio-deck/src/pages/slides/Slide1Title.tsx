      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "1vw" }}>
            <div
              style={{
                width: "3vw", height: "3vw", backgroundColor: "#2d3748", borderRadius: "0.8vw",
                display: "flex", alignItems: "center", justifyContent: "center",
                color: "#ffffff", fontWeight: "bold", fontSize: "1.4vw",
              }}
            >
              RV
            </div>
          ...
          <div
            style={{
              backgroundColor: "#ffbca6", padding: "0.8vh 1.5vw",
              borderRadius: "2vw", fontSize: "1vw", fontWeight: 700, color: "#2d3748",
            }}
          >
            Portfolio · 2026
          </div>
        ...
        {/* Title block */}
        <div style={{ maxWidth: "52vw", marginBottom: "auto", marginTop: "8vh" }}>
          <div
            style={{
              display: "inline-block", padding: "0.5vh 1vw",
              backgroundColor: "#e2e8f0", borderRadius: "0.5vw",
              fontSize: "1vw", fontWeight: 700, color: "#4a5568",
              marginBottom: "2.5vh", textTransform: "uppercase", letterSpacing: "0.12vw",
            }}
          >
            GLA University · B.Tech CSE · 2024–2028
          </div>
          <h1
            style={{
              fontSize: "6.5vw", fontWeight: 800, lineHeight: 1.05, margin: 0,
              color: "#1a202c", letterSpacing: "-0.1vw", textWrap: "balance",
            }}
          >
            Ritika Varshney
          </h1>
          <p
            style={{
              fontSize: "2vw", fontWeight: 500, color: "#4a5568",
              marginTop: "2.5vh", lineHeight: 1.4,
            }}
          >
          ...
          <p
            style={{
              fontSize: "1.7vw", fontWeight: 400, color: "#718096",
              marginTop: "1.5vh", lineHeight: 1.5,
            }}
          >
        ...
        <div
          style={{
            ...
            paddingTop: "2.5vh", borderTop: "0.15vw solid rgba(45,55,72,0.12)",
          }}
        >
          <div style={{ fontSize: "1.2vw", fontWeight: 500, color: "#718096" }}>varshneyritika01@gmail.com</div>
